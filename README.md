The project was made as final project of the Digital System's discipline (INE5406). It is an Arithmetic-Logic Unit (ALU) with Triple Modular Redundancy (TMR). The idea of the project was
